"""
Figure 5: VMT by passenger vehicle mode - Cordon area.
...
def main():
    ...
    ax_top.set_ylim(bottom=300000, top=700000)
    ...
    fig.savefig('Figure_5.pdf', dpi=300, bbox_inches='tight', facecolor='white')
    fig.savefig('Figure_5.tiff', dpi=300, bbox_inches='tight', facecolor='white')
    print('Saved: Figure_5.pdf')
    print('Saved: Figure_5.tiff')
    plt.close()
